...
CREATE TABLE `gaji` (
  ...
  `tunjangan_makan` int(11) NOT NULL DEFAULT 0,
  `tunjangan_transport` int(11) NOT NULL DEFAULT 0,
...
ALTER TABLE `gaji`
  ADD PRIMARY KEY (`id`),
  ADD KEY `gaji_karyawan_idx` (`karyawan_id`);
...
ALTER TABLE `gaji`
  ADD CONSTRAINT `gaji_karyawan_fk` FOREIGN KEY (`karyawan_id`) REFERENCES `karyawan` (`id`) ON DELETE CASCADE;
COMMIT;
